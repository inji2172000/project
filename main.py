...
class Face_Recognition_System:
    def __init__(self,root):
        ...
        tiltle_lbl=Label(bg_img,text="FACE RECOGNITION ATTENDANCE SYSTEM SOFTWARE",font=("times new roman",35,"bold"),bg="black",fg="white")
        tiltle_lbl.place(x=0,y=0,width=1545,height=45)

        #student button
        img4=Image.open(r"D:\project\images\5.png")
        ...
        #detect face button
        img5=Image.open(r"D:\project\images\5.png")
        ...
        #attendance button
        img6=Image.open(r"D:\project\images\5.png")
        ...
        #Train button
        img7=Image.open(r"D:\project\images\5.png")
